					...
					if ($class == "sleeper") {
						...
						if (mysqli_stmt_num_rows($stmt) == 0) {
							...
							while (mysqli_stmt_fetch($stmt)) {
								...
								<td>" . $seats_sleeper . "</td>
								<td>&#x20b9; " . $price_sleeper . "</td>
								<td><input type=\"radio\" name=\"select_train\" value=\"" . $train_no . "\" required></td>
        						</tr>";
							}
							echo "</table> <br>";
							echo "<input style=\"margin-left:600px; margin-top: 20px;\" type=\"number\" name=\"no_of_pass\" placeholder=\"No. of tickets\" min=\"0\" max=\"6\">";
							echo "<input style=\"margin-left:600px;font-size:15px; margin-top: 20px;cursor:pointer;\" type=\"submit\" value=\"Book Tickets\" name=\"Select\">";
							echo "</form>";
						}
					} else if ($class = "ac") {
