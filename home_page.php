...
<body>
	...
	<br><br>
	<h1 style="text-align:center;color:#030337;">WELCOME TO MyRailway</h1>
	<div style="margin-top:100px">
		<form class="float_form" style="padding-left: 100px; font-size: 20px;" action="train_details.php" method="POST">
			<fieldset style="padding: 10px;background-color:whitesmoke;">
				...
				<table cellpadding="5">
					...
					<tr>
						<td class="fix_table"><input type="number" name="no_of_pass" placeholder="Eg. 5" min="1"
								max="10" required></td>
					</tr> -->
				</table>
				<br>
				<input type="submit" value="Search for Trains" name="Search"
					style="margin-top:10px;margin-left:200px;cursor:pointer;font-size:15px;">
			</fieldset>
		</form>
	</div>
</body>
